...
//            destination.viewModel.decimal   = "\((sender as! Info).decimal)"
            ...
            destination.viewModel.comfortIndex = (sender as! Info).comfortIndex
            destination.viewModel.safetyIndex = (sender as! Info).safetyIndex
            destination.viewModel.securityIndex = (sender as! Info).securityIndex
